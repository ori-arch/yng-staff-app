      ...
      <div style={{ display: "flex", gap: 8, marginTop: 4 }}>
        ...
        <button
          ...
          style={{
            ...
            padding: 8,
            borderRadius: 8,
            border: value === false ? "2px solid var(--ink)" : "1px solid var(--border-strong)",
            background: value === false ? "var(--ink)" : "transparent",
...
export default function LoftCleaningPage() {
  ...
  return (
    <div className="container">
      <h1 className="page-title">Loft Cleaning Duties</h1>
      <p className="page-sub">Periodic facilities duty, separate from restocking.</p>
